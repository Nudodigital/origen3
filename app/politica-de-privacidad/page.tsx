...
export default function PoliticaPrivacidadPage() {
  return (
    <section className="pt-36 pb-24 lg:pt-44 lg:pb-32 bg-[#0D0C0B]">
      <div className="max-w-3xl mx-auto px-6 lg:px-0">
        <p className="text-[10px] tracking-[0.35em] uppercase text-[#C9A96E] mb-6">
          Legal
        </p>
        <h1 className="font-display text-4xl lg:text-5xl text-[#F2EDE4] mb-12">
        ...
        <div className="prose-custom flex flex-col gap-10">
          {/* Sección 1 */}
          <div>
            <h2 className="font-display text-xl text-[#F2EDE4] mb-4">
              1. Identidad y domicilio del Responsable
            </h2>
            <p className="text-sm text-[#6B6560] leading-loose">
            ...
            <p className="text-sm text-[#6B6560] leading-loose mt-3">
              ...
              <a
                ...
                className="text-[#C9A96E] hover:text-[#F2EDE4] transition-colors"
              >
                hola@origen3.com.mx
              </a>
            </p>
          ...
          <div>
            ...
            <p className="text-sm text-[#6B6560] leading-loose mb-3">
            ...
            <ul className="flex flex-col gap-2 pl-4">
              {[
                ...
                <li key={item} className="text-sm text-[#6B6560] leading-loose flex gap-3">
                  <span className="text-[#C9A96E] shrink-0 mt-1">—</span>
                  {item}
                </li>
              ))}
            </ul>
            <p className="text-sm text-[#6B6560] leading-loose mt-4">
              Origen3 <strong className="text-[#F2EDE4]">no recaba datos personales sensibles</strong> para
          ...
          <div>
            ...
            <p className="text-sm text-[#6B6560] leading-loose mb-3">
              ...
              <strong className="text-[#F2EDE4]"> finalidades primarias</strong>, necesarias para la
            ...
            <p className="text-sm text-[#6B6560] leading-loose mb-3">
              De manera <strong className="text-[#F2EDE4]">secundaria</strong>, y solo con su
          ...
          <div>
            ...
            <p className="text-sm text-[#6B6560] leading-loose mb-3">
              ...
              <strong className="text-[#F2EDE4]">Acceso, Rectificación, Cancelación y Oposición</strong>{" "}
              (derechos ARCO) respecto al tratamiento de sus datos personales.
              Para ello, deberá enviar una solicitud por escrito a:
            </p>
            <p className="text-sm text-[#C9A96E] leading-loose">
              hola@origen3.com.mx
            </p>
            <p className="text-sm text-[#6B6560] leading-loose mt-3">
