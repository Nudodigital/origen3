...
export default function PoliticaPrivacidadPage() {
  return (
    <section className="pt-40 pb-28 lg:pt-52 lg:pb-40 bg-[#FFFFFF]">
      <div className="max-w-3xl mx-auto px-6 lg:px-0">
        <p className="text-[11px] tracking-[0.35em] uppercase font-bold text-[#C9A96E] mb-8">
          Legal
        </p>
        <h1 className="font-display font-black text-5xl lg:text-7xl tracking-tight text-[#111111] mb-16 uppercase">
          Política de Privacidad
        </h1>

        <div className="prose-custom flex flex-col gap-12">
          <div>
            <h2 className="font-display font-black text-2xl lg:text-3xl tracking-tight text-[#111111] mb-5 uppercase">
            ...
            <p className="text-base text-[#6B6B6B] leading-loose mt-4">
              ...
              <a
                ...
                className="text-[#111111] font-semibold border-b-2 border-[#C9A96E] hover:text-[#C9A96E] transition-colors"
              >
                hola@origen3.com.mx
              </a>
            </p>
          ...
          <div>
            ...
            <p className="text-base text-[#6B6B6B] leading-loose mb-4">
            ...
            <ul className="flex flex-col gap-3 pl-4">
              {[
                ...
                <li key={item} className="text-base text-[#6B6B6B] leading-loose flex gap-3">
                  <span className="text-[#C9A96E] font-bold shrink-0 mt-1">—</span>
                  {item}
                </li>
              ))}
            </ul>
            <p className="text-base text-[#6B6B6B] leading-loose mt-5">
              Origen3 <strong className="text-[#111111] font-bold">no recaba datos personales sensibles</strong> para
          ...
          <div>
            ...
            <p className="text-base text-[#6B6B6B] leading-loose mb-4">
              ...
              <strong className="text-[#111111] font-bold"> finalidades primarias</strong>, necesarias para la
              relación jurídica entre usted y Origen3:
            </p>
            <ul className="flex flex-col gap-3 pl-4 mb-5">
              {[
            ...
            <p className="text-base text-[#6B6B6B] leading-loose mb-4">
              De manera <strong className="text-[#111111] font-bold">secundaria</strong>, y solo con su
          ...
          <div>
            ...
            <p className="text-base text-[#6B6B6B] leading-loose mb-4">
              ...
              <strong className="text-[#111111] font-bold">Acceso, Rectificación, Cancelación y Oposición</strong>{" "}
              (derechos ARCO) respecto al tratamiento de sus datos personales.
              Para ello, deberá enviar una solicitud por escrito a:
            </p>
            <p className="text-lg font-display font-black tracking-tight text-[#111111] leading-loose">
              hola@origen3.com.mx
            </p>
            <p className="text-base text-[#6B6B6B] leading-loose mt-4">
          ...
          <div className="border-t border-[#E5E5E5] pt-10">
            <p className="text-xs tracking-[0.2em] uppercase font-semibold text-[#6B6B6B]">
